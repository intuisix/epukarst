 ...
 */
final class Version20191105104408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reading (id INT NOT NULL, station_id INT NOT NULL, encoding_author_id INT NOT NULL, validation_author_id INT DEFAULT NULL, code VARCHAR(255) NOT NULL, field_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, encoding_date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, encoding_notes TEXT NOT NULL, validation_date_time TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, validation_notes TEXT DEFAULT NULL, PRIMARY KEY(id))');
